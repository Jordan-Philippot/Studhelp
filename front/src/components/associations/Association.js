    ...
    return (
        <div className="association-component col-10 col-sm-8 col-md-5 col-lg-5 col-xl-5">
            ...
            <div className="d-flex justify-content-center address">
                ...
                <p>{props.assoc.address} <br></br> ( {props.assoc.distance} km )</p>
            </div>
            <button className="btn btn-turquoiseOut" onClick={() => history.push("/association/" + props.assoc.id)}>Voir l'association</button>
        </div>
    )
}
