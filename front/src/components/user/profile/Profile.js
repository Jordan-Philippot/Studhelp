...
import Illustration from '../../../images/todo.png'
...
export default function Profile(props) {
    ...
    return (
        <div>
            ...
            <img className="illustration w-10" src={Illustration} alt="Students happy illustration" />
            ...
            <div className="col-xl-8 pl-0">
                ...
                <button className="btn-alizFull mb-5" onClick={handleProfile}>Enregistrer</button>
